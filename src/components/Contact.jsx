...
//bg-black-100
  return (
    <div className={`xl:mt-12 flex xl:flex-row flex-col-reverse gap-10 overflow-hidden `}>
      <motion.div variants={slideIn("left", "tween", 0.2, 1)} className='flex-[0.75]  p-8 rounded-2xl backdrop-blur-sm border-2 border-gray-700 bg-gray-800/70'>
      ...
      <motion.div variants={slideIn("right", "tween", 0.2, 1)} className='hidden md:block xl:flex-1 xl:h-auto md:h-[550px] h-[350px]'>
        <EarthCanvas />
      </motion.div>
    </div>
  );
