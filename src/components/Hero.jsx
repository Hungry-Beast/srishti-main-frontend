...
const Hero = () => {
  ...
  return (
    <section
      className={`relative w-full lg:h-screen mx-auto mt-[12em] grid  sm:flex items-center justify-center lg:justify-center lg:items-center  font-potra `}>
      {/* <ComputersCanvas /> */}

      <div className="font-potra mt-12 md:mt-0  relative justify-self-start flex flex-col md:items-center md:justify-center z-10  max-w-7xl mx-auto  ">
        <h1
